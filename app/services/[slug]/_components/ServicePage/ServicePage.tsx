      ...
      <Grid container spacing={4} justifyContent="center">
        <Grid item xs={12} sm={6}>
          ...
          <Typography variant="subtitle1">
            We start by understanding your business, goals, and target audience to create a detailed plan for your website.
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
          <Typography variant="h6" gutterBottom>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <Typography variant="subtitle1">
            After launch, we provide ongoing support and maintenance to keep your website up-to-date and running smoothly.
          </Typography>
        </Grid>
      </Grid>
    </Box>
