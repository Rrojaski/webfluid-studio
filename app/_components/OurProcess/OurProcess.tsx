  ...
  return (
    <Box className="our-process-component-container">
      ...
      <Box className="our-process-item">
        ...
        <Typography variant="h5" sx={{ fontWeight: 'bold' }}>1.Website Design & Development</Typography>
      ...
      <Box className="our-process-item">
        ...
        <Typography variant="h5" sx={{ fontWeight: 'bold' }}>1.Website Launch & Support</Typography>
