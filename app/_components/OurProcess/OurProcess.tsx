  ...
  return (
    <Box className="our-process-component-container">
      <Box className="our-process-item">
        <img src="/images/ourprocess-guy-1.svg" alt="Group hugging" />
      ...
      <Box className="our-process-item">
        <img src="/images/ourprocess-guy-2.svg" alt="Group hugging" />
      ...
      <Box className="our-process-item">
        <img src="/images/ourprocess-guy-3.svg" alt="Group hugging" />
