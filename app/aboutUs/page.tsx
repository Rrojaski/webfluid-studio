      ...
      <Box mb={15}>
        <Container maxWidth="lg" id="our-story-container">
          ...
          <Typography variant="h6" maxWidth={910}>
            ...
            wealth of expertise and a passion for innovation. We are committed to delivering high-quality, tailored solutions that help businesses enhance their
            online presence and achieve their digital goals. Join us as we embark on this exciting journey to make a significant impact in the digital
            landscape.
          </Typography>
        </Container>
      </Box>
