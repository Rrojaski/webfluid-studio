...
export const BlogPosts = [
  post(
    ...
    Label.Features,
    "https://images.webfluid.studio/Popular-communication-apps-for-customer-support-min.png",
  ...
  post(
    ...
    Label.TipsTricks,
    "https://images.webfluid.studio/03yy022DDsenwhBBYdxvwDi-3.webp",
  ...
  post(
    ...
    Label.Security,
    "https://images.webfluid.studio/cyber_safety.jpg",
  ...
  post(
    ...
    Label.Features,
    "https://images.webfluid.studio/shutterstock_2058513980-scaled.webp",
  ...
  post(
    ...
    Label.TipsTricks,
    "https://images.webfluid.studio/Project_Management.jpg",
  ...
  post(
    ...
    Label.Features,
    "https://images.webfluid.studio/A-Brain-Friendly-Guide-to-Using-AI-at-Work-1.png",
  ...
  post(
    ...
    Label.TipsTricks,
    "https://images.webfluid.studio/virtual-team-collaboration_blog.jpg",
  ...
  post(
    ...
    Label.TipsTricks,
    "https://images.webfluid.studio/1_4IpEtoXrvZY4oVt96v69vw.jpg",
  ...
  post(
    ...
    Label.TipsTricks,
    "https://images.webfluid.studio/confident-handsome-young.jpg",
